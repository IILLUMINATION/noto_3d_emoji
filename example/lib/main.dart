...
/// Root widget of the Noto 3D Emoji example app.
...
/// Main screen that manages font loading and shows the showcase.
...
class _EmojiScreenState extends State<EmojiScreen> with SingleTickerProviderStateMixin {
  bool _loading = false;
  bool _ready = false;
  double _progress = 0;
  String? _error;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Failed to load font', style: Theme.of(context).textTheme.titleLarge),
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              (context.findAncestorStateOfType<_EmojiScreenState>() as dynamic)?.setState(() {});
            },
          ),
        ],
      ),
        ...
        child: Column(
          children: [
            ...
            EmojiText(
              ...
              style: TextStyle(fontSize: emojiRowSize, color: cs.onPrimaryContainer),
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 12),
            EmojiText(
              '\u{1F525} \u{1F680} \u{2764}\u{FE0F} \u{1F60D} \u{1F4AF} \u{1F3B5}',
              style: TextStyle(fontSize: emojiRowSize - 12, color: cs.onPrimaryContainer),
              textAlign: TextAlign.center,
            ),
          ],
        ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () => setState(() => _preview = _ctrl.text),
                ),
              ),
...
class _SampleTexts extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            _sampleRow(context, cs, 'Rating:', '\u{2B50}\u{2B50}\u{2B50}\u{2B50}\u{2B50}'),
            const Divider(height: 16),
            _sampleRow(context, cs, 'Status:',
            ...
            const Divider(height: 16),
            _sampleRow(
                context, cs, 'Stack:', 'Flutter \u{1F3AE} + Dart \u{1F426} = \u{2764}\u{FE0F}'),
            const Divider(height: 16),
            _sampleRow(context, cs, 'Hero:', '\u{1F44B} Welcome! \u{1F389} \u{1F37B}'),
          ],
        ),
      ),
    );
  ...
  Widget _sampleRow(BuildContext context, ColorScheme cs, String label, String text) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('Add to your app:', style: Theme.of(context).textTheme.labelLarge),
            const SizedBox(height: 4),
            Container(
              width: double.infinity,
